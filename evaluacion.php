...
/**
 * Array obtained from the user's POST
 * */
...
$a_div_patron = []; //Recibirá la matriz de los patrones divididos por enfermedad
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="home.php">Inicio</a></span> <span>Evaluación Diagnóstico Específico</span></p>
