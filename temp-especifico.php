    ...
    <div class="hero-wrap js-fullheight">
     ...
     <section class="ftco-section">
      <div class="container">
        ...
        <form method="GET" action="evaluacion.php" class="needs-validation" novalidate>
                     ...
                     <div class="col-md-12">
                        ...
                        <img class="img-feelings2" src="https://image.flaticon.com/icons/svg/1742/1742491.svg" alt="">
                          ...
                          <label for="range" class=" mt-1 text-center">
                                <input type="range" name="valSintomas[]" id="range2" min="0" max="1" step="0.01" value="0" onchange="cambiar(this.value, <?php echo $sintoma['id_enf_sint'];?>)" oninput="cambiar(this.value, <?php echo $sintoma['id_enf_sint'];?>)"><h4 class="text-center txt-range"  id="<?php echo $sintoma['id_enf_sint'];?>">0%</h4>
                          </label>
                     </li>
                 </ul>                
                 <?php endforeach; ?>
        ...
        window.addEventListener('load', function () {
            ...
            var validation = Array.prototype.filter.call(forms, function (form) {
                form.addEventListener('submit', function (event) {
                    ...
                    if ($("[name='disease[]']:checked").length == 0) {
                        $("[name='disease[]']").attr('required', true);
                        failed = true;
                    }
                    else {
                        $("[name='disease[]']").attr('required', false);
                    }
